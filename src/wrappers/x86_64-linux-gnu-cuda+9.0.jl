# Autogenerated wrapper script for CUDA_Toolkit_jll for x86_64-linux-gnu-cuda+9.0
...
JLLWrappers.@declare_library_product(libcublas, "libcublas.so.9.0")
JLLWrappers.@declare_file_product(libcudadevrt)
JLLWrappers.@declare_library_product(libcufft, "libcufft.so.9.0")
JLLWrappers.@declare_library_product(libcupti, "libcupti.so.9.0")
JLLWrappers.@declare_library_product(libcurand, "libcurand.so.9.0")
JLLWrappers.@declare_library_product(libcusolver, "libcusolver.so.9.0")
JLLWrappers.@declare_library_product(libcusparse, "libcusparse.so.9.0")
